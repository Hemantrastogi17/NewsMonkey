...
export class News extends Component {
    ...
    async componentDidMount() {
        let url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=30400ec924b640ec95b703ff4043275c&page=1";
    ...
    handleNextClick = async () => {
        ...
        if (this.state.page + 1 > Math.ceil(this.state.totalResults / 20)) {
            ...
            let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=30400ec924b640ec95b703ff4043275c&page=${this.state.page + 1}&pageSize=20`;
            let data = await fetch(url);
            let parsedData = await data.json();
            console.log(parsedData);
            this.setState({
    ...
    handlePreviousClick = async () => {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=30400ec924b640ec95b703ff4043275c&page=${this.state.page - 1}`;
        let data = await fetch(url);
        let parsedData = await data.json();
        console.log(parsedData);
        this.setState({
